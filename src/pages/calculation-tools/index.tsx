...
const CalculationToolsPage: React.FC = () => {
  ...
  const calculationTools = toolsConfig.filter(tool => tool.group === 'calculation');
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="text-center mb-12">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900">Calculation Tools</h1>
          </div>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Professional calculators and computation tools for financial, scientific, and everyday calculations.
          </p>
        </div>
