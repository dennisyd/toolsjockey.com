    ...
    <div className="flex-1 flex flex-col container-app w-full mx-auto px-2 md:px-0">
      ...
      <section className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-8 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Privacy & Security - Character Card */}
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-slate-700 text-center">
            ...
            <div className="w-24 h-24 bg-gradient-to-br from-green-100 to-blue-100 rounded-lg mx-auto mb-4 flex items-center justify-center relative">
              {/* Character illustration */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-16 h-20 bg-blue-400 rounded-full flex items-end justify-center">
                  <div className="w-12 h-8 bg-blue-300 rounded-full mb-1"></div>
                </div>
          ...
          {/* No Uploads Required - Character Card */}
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-slate-700 text-center">
            ...
            <div className="w-24 h-24 bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg mx-auto mb-4 flex items-center justify-center relative">
              {/* Character illustration */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-16 h-20 bg-yellow-400 rounded-full flex items-end justify-center">
                  <div className="w-12 h-8 bg-yellow-300 rounded-full mb-1"></div>
                </div>
                <div className="absolute -left-2 top-2 w-8 h-8 bg-red-500 rounded-full flex items-center justify-center">
          ...
          {/* Works Everywhere - Character Card */}
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-slate-700 text-center">
            ...
            <div className="w-24 h-24 bg-gradient-to-br from-purple-100 to-pink-100 rounded-lg mx-auto mb-4 flex items-center justify-center relative">
              {/* Character illustration */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-16 h-20 bg-blue-500 rounded-full flex items-end justify-center">
                  <div className="w-12 h-8 bg-blue-400 rounded-full mb-1"></div>
                </div>
                <div className="absolute -right-2 bottom-2 w-6 h-8 bg-gray-300 rounded"></div>
              </div>
            </div>
            <p className="text-gray-600 dark:text-gray-300 text-sm">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl p-6 shadow-lg border border-gray-100 dark:border-slate-700 text-center">
            ...
            <div className="w-24 h-24 bg-gradient-to-br from-orange-100 to-yellow-100 rounded-lg mx-auto mb-4 flex items-center justify-center relative">
              {/* Character illustration */}
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-16 h-20 bg-purple-500 rounded-full flex items-end justify-center">
                  <div className="w-12 h-8 bg-purple-400 rounded-full mb-1"></div>
                </div>
                <div className="absolute -right-2 top-2 w-8 h-8 bg-yellow-400 rounded-full flex items-center justify-center">
                  <div className="w-4 h-4 bg-white rounded-full"></div>
                </div>
              </div>
            </div>
