...
export const toolsConfig: ToolMeta[] = [
  ...
  },
  {
    ...
    title: 'Split PDF',
    path: '/split-pdf',
    description: 'Extract specific pages or ranges from PDFs.',
    icon: DocumentDuplicateIcon,
    group: 'pdf',
  },
  {
  ...
  },
  {
    ...
    path: '/rotate-pdf',
    description: 'Rotate any page left/right in PDFs.',
    icon: DocumentDuplicateIcon,
    group: 'pdf',
  },
  {
    ...
    title: 'Watermark PDF',
    path: '/watermark-pdf',
    description: 'Add styled text overlays to every page.',
    icon: DocumentDuplicateIcon,
    group: 'pdf',
  },
  {
    ...
    title: 'PDF to Images',
    path: '/pdf-to-images',
    description: 'Export PDF pages as PNG or JPEG.',
    icon: DocumentDuplicateIcon,
    group: 'pdf',
  },
  {
  ...
  },
  {
    ...
    path: '/delete-pages',
    description: 'Remove specific pages from PDFs.',
    icon: DocumentDuplicateIcon,
    group: 'pdf',
  },
  {
    ...
    path: '/edit-metadata',
    description: 'Modify PDF document properties.',
    icon: DocumentDuplicateIcon,
    group: 'pdf',
  },
  {
