...
export const toolsConfig: ToolMeta[] = [
  ...
  // Presentation Tools
  {
    ...
    description: 'Convert PowerPoint presentations to PDF, 100% client-side.',
    icon: DocumentArrowDownIcon,
    group: 'presentation',
  },
  {
    id: 'pptx-to-images',
    title: 'PPTX to Images Converter',
    path: '/tools/pptx-to-images',
    description: 'Convert slides to individual images (PNG/JPG) in your browser.',
  ...
  },
  {
    id: 'pptx-splitter',
    title: 'PPTX Splitter',
    path: '/tools/pptx-splitter',
    description: 'Extract specific slides or split by range.',
    icon: DocumentArrowDownIcon,
    group: 'presentation',
  },
  {
    ...
    path: '/tools/pptx-extract-text',
    description: 'Pull out all text content from slides.',
    icon: DocumentTextIcon,
    group: 'presentation',
  },
  {
    id: 'pptx-metadata-editor',
    title: 'PPTX Metadata Editor',
    path: '/tools/pptx-metadata-editor',
    description: 'Edit presentation properties and information.',
    icon: PencilSquareIcon,
    group: 'presentation',
  },
  {
    id: 'pptx-slide-counter',
    title: 'Slide Counter',
    path: '/tools/pptx-slide-counter',
    description: 'Count slides and analyze presentation structure.',
    icon: ChartBarIcon,
    group: 'presentation',
  },
  // Audio Tools
